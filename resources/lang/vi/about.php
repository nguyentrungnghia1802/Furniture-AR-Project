...
return [
    ...
    'artisan_crafted_desc' => 'Mỗi sản phẩm được chế tác cẩn thận bằng tay bởi những nghệ nhân lành nghề.',
    'premium_materials' => 'Vật liệu cao cấp',
    'premium_materials_desc' => 'Chúng tôi chỉ sử dụng những vật liệu tốt nhất để đảm bảo chất lượng vượt trội.',
    ...
    'fast_delivery_desc' => 'Giao hàng nhanh chóng và đáng tin cậy đến tận nhà',
    'excellent_support' => 'Hỗ Trợ Xuất Sắc',
    'excellent_support_desc' => 'Đội ngũ của chúng tôi luôn sẵn sàng giúp đỡ bạn',
    ...
    'sustainability_value' => 'Bền vững',
    'sustainability_value_desc' => 'Chúng tôi ưu tiên vật liệu thân thiện môi trường và thực hành bền vững.',
    'creativity_value' => 'Sáng tạo',
    ...
    'store_hours' => 'Giờ mở cửa',
    'monday_friday' => 'Thứ Hai - Thứ Sáu',
    'saturday_sunday' => 'Thứ Bảy - Chủ Nhật',
    'address' => 'Địa chỉ',
    'phone' => 'Điện thoại',
    'email' => 'Email',
    ...
    'contact_for_custom' => 'Liên hệ để đặt hàng tùy chỉnh',
