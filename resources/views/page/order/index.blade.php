<x-app-layout>
    <div class="max-w-7xl mx-auto px-2 sm:px-4 py-6 sm:py-12">
        <!-- Page Title -->
        <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center">📝{{ __('orders.orders_title') }}</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-500">{{ __('orders.delivered') }}</p>
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-yellow-500">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-500">{{ __('orders.processing') }}</p>
                                    <p class="text-2xl font-bold text-gray-900">
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-500">{{ __('orders.total_value') }}</p>
                                    <p class="text-2xl font-bold text-gray-900">
                                    ...
                                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center space-x-3 mb-4">
                                                ...
                                                <div>
                                                    <h3 class="text-lg font-bold text-gray-900">{{ __('orders.order_id') }}
                                                        #{{ $order->id }}</h3>
                                            ...
                                            <div class="flex items-center space-x-2 mb-4">
                                                <span class="text-sm font-medium text-gray-600">{{ __('orders.products') }}</span>
