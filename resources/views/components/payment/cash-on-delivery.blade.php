<div 
    ...
    <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold">{{ __('payment.cash_on_delivery_title') }}</h3>
        ...
        <div class="bg-green-50 rounded-md p-4 mb-4">
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-green-800">{{ __('payment.convenient_payment') }}</h3>
                    <div class="mt-2 text-sm text-green-700">
                        <p>{{ __('payment.pay_on_delivery') }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-4">
            <div class="flex items-start">
                ...
                <div class="ml-3 text-sm">
                    <label for="terms" class="font-medium text-gray-700">{{ __('payment.agree_cod_terms') }}</label>
                    <p class="text-gray-500">{{ __('payment.pay_full_on_delivery') }}</p>
