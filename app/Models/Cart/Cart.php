...
use App\Models\Product\Product;              // Base Eloquent model
use App\Models\User; // Factory pattern support
use Illuminate\Database\Eloquent\Factories\HasFactory;                     // Product relationship
use Illuminate\Database\Eloquent\Model;                                // User relationship
