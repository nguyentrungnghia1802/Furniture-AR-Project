...
use App\Models\Address; // Factory support for testing
use App\Models\Product\Review;                // Base Eloquent model class
use App\Models\User;                     // User model for customer relationships
use Illuminate\Database\Eloquent\Factories\HasFactory;           // Review model for post-purchase feedback
use Illuminate\Database\Eloquent\Model;                  // Address model for shipping information
