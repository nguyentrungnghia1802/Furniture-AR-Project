...
use App\Models\Order\Order; // Product category model
use App\Models\Post;  // Product model for inventory data
use App\Models\Product\Category;             // User model for customer analytics
use App\Models\Product\Product;             // Post model for content management
use App\Models\User;      // Order model for sales analytics
// Order detail model for detailed sales data
// Laravel caching system for performance
// Database query builder
use Carbon\Carbon;     // HTTP request handling
use Illuminate\Http\Request;               // Date manipulation library
