...
use App\Models\Post;                 // HTTP request handling
use App\Models\Product\Category;              // Product model for product data
use App\Models\Product\Product;             // Category model for organization
use Illuminate\Http\Request;                         // Post model for blog content
use Illuminate\Support\Facades\Cache;           // Database query builder
use Illuminate\Support\Facades\DB;        // Caching system for performance
